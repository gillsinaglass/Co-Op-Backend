...
collaboration3 = Collaboration.create(name: "Welcome to the Jungle - Code", description: "Seemlessly play Welcome to the jungle over and over again.", git_hub: "facebook.com", user_id: kyle.id, status:"Closed", image_one: "https://www.investorsgroup.com/content/dam/investorsgroup/more/2016/10/IG_working_from_home.jpg")
collaboration4 = Collaboration.create(name: "Designer needed for chatbot application", description: "This chatbot will require a multitude of uses and etcetera.", git_hub: "facebook.com", user_id: matt.id, status:"Active", image_one: "https://www.investorsgroup.com/content/dam/investorsgroup/more/2016/10/IG_working_from_home.jpg")
